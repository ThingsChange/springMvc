    ...
    autocomplete.prototype = {
        ...
        appendChild: function(data) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                child.style.width = self.showdiv.style.width-1;
            ...
            //为下拉框添加enter事件
            self.util.AddEvt(self.showdiv, 'keydown', function(e) {
                var evt = e || window.event;
                var target = evt.srcElement || evt.target;
            ...
            //为下拉框添加鼠标划过事件
            self.util.AddEvt(self.showdiv, 'mouseover', function(e) {
                var evt = e || window.event;
                var target = evt.srcElement || evt.target;
                var key = target.getAttribute("key");
                var val = target.innerHTML;
            ...
            //为下拉框添加鼠标划过事件
            self.util.AddEvt(self.showdiv, 'mouseout', function(e) {
                var evt = e || window.event;
                var target = evt.srcElement || evt.target;
                var key = target.getAttribute("key");
                var val = target.innerHTML;
