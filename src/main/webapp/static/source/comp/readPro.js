...
var fs = require('fs');
/*    path=require('path');
var filePath='../../../WEB-INF/application.properties';
var readScream=fs.createReadStream(filePath);
readScream.on("",function () {
    
})*/

var parseproperties = function(uri, encoding){
...
var x=parseproperties('../../../WEB-INF/application.properties');
console.log("<<<<<查询结束>>>>>>");
console.log(x.url);